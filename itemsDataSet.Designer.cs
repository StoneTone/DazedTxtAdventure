...
namespace FinalProjectAS {
    ...
    public partial class itemsDataSet : global::System.Data.DataSet {
        ...
        public partial class itemsDataTable : global::System.Data.TypedTableBase<itemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public itemsRow AdditemsRow(int ItemID, string Items, string Description) {
...
namespace FinalProjectAS.itemsDataSetTableAdapters {
    ...
    public partial class itemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[items] WHERE (([ItemID] = @Original_ItemID) AND ((@IsNull_Item" +
                "s = 1 AND [Items] IS NULL) OR ([Items] = @Original_Items)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[items] ([ItemID], [Items], [Description]) VALUES (@ItemID, @It" +
                "ems, @Description);\r\nSELECT ItemID, Items, Description FROM items WHERE (ItemID " +
                "= @ItemID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[items] SET [ItemID] = @ItemID, [Items] = @Items, [Description] = @Description WHERE (([ItemID] = @Original_ItemID) AND ((@IsNull_Items = 1 AND [Items] IS NULL) OR ([Items] = @Original_Items)));
SELECT ItemID, Items, Description FROM items WHERE (ItemID = @ItemID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FinalProjectAS.Properties.Settings.Default.itemsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ItemID, Items, Description FROM dbo.items";
        ...
        public virtual int Delete(int Original_ItemID, string Original_Items) {
        ...
        public virtual int Insert(int ItemID, string Items, string Description) {
        ...
        public virtual int Update(int ItemID, string Items, string Description, int Original_ItemID, string Original_Items) {
            ...
            if ((Original_Items == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_Items));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Items, string Description, int Original_ItemID, string Original_Items) {
            return this.Update(Original_ItemID, Items, Description, Original_ItemID, Original_Items);
        }
    }
